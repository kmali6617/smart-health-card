...
if (!empty($BloodPressure) || !empty($BloodSuger) || !empty($BodyTemprature) || !empty($Weight) || !empty($Prescription)) {
 $host = "localhost";
    ...
    if (mysqli_connect_error()) {
     ...
     $SELECT = "SELECT BloodPressure From hackathon Where BloodPressure = ? Limit 1";
     $INSERT = "INSERT Into hackathon (BloodPressure, BloodSuger, BodyTemprature, Weight,Prescription) values('$BloodPressure','$BloodSuger','$BodyTemprature','$Weight','$Prescription')";
     //Prepare statement
