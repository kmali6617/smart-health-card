	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="login100-pic js-tilt" data-tilt>
				<form >
					<img src="images/bg_4.jpg" alt="IMG" style="border-radius:25%; margin-top: 37px;">
				</form>
				</div>
				...
				<form class="login100-form validate-form" action="loginprocess.php"  method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" placeholder="Reg_ID">
					...
					<div class="text-center p-t-70">
						<a class="txt2" href="../Patient/PatientReg.html">
