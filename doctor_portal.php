	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
						    <p class="mb-0 register-link"><a href="home.html" class="mr-3">Log Out</a></p>
					    </div>
				    </div>
			    </div>
		    </div>
        ...
        <input type="image" src="favicon/logo.png"  width="40" height="40">&nbsp &nbsp &nbsp &nbsp
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="doctorpronew.php" class="nav-link"><span>Profile</span></a></li>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="post" id="reused_form" action="Patient/partient_details.php">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="single-services text-center">
                            ...
                            <div class="services-content">
                                <h3>ALL REPORTS OF PATIENT</a></h3> <!--edit the service you give-->
                                <p></p>
                            </div>
                        </div>
                    </div>
