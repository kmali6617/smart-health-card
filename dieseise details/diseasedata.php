...
$doc1= $_SESSION['doctor-id'];

$sql ="SELECT * FROM disease where docid='".$doc1."'";
...
<body style="text-align:center;">
            ...
            <div>
              ...
              <td colspan="4" style="font-size:30px;color:black" bgcolor="#007acc" >
               <b>Disease Details</b></td></tr></table>

               <?php while($row = mysqli_fetch_array($search_result)):?>
                <table class="table table-bordered" id="customers" border="0" align="center">
                <tr>
              <td colspan="4" style="font-size:30px;color:black" bgcolor="#007acc" >
               <b>Case <?php $c++; echo $c; ?></b></td></tr>
                ...
                <tr>
                  <th>File</th>
                  <td><a href="../uploads_report/<?php echo $row['myfile'];?>"><?php echo $row['myfile'];?></a></td>
                </tr>
                <!-- <tr>
